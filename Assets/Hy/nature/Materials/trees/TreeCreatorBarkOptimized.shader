...
Properties {
	...
	_TranslucencyMap ("Trans (RGB) Gloss(A)", 2D) = "white" {}
        _ramp ("ramp", 2D) = "white" {}
        _outlineWidth ("outlineWidth", Range(0, 0.1)) = 0.04648411
...
//add terrain cginc to make tree move
